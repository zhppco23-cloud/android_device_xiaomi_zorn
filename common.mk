...
#
# This file is a zorn-local product configuration snapshot of sm8650-common.
# Keep common resource paths explicit while zorn owns all proprietary blobs.
LOCAL_PATH := device/xiaomi/sm8650-common


# Call the proprietary setup.
# zorn uses its self-contained proprietary vendor tree.
